...
@section('content')
    ...
    <section class="d-none d-lg-block d-xl-block" style="padding:10;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xs-12" data-animate="fadeInLeft"><img src="{{ asset('images/passionfood/aboutus/food1.jpg') }}"
                        style="display:block; margin:auto;" onContextMenu="return false;" width="90%"></div>
    ...
    <section class="d-block d-lg-none" style="padding:0;">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <h1 class="text-center mt-5" data-animate="fadeInUp" style="font-size:2.4rem; color:#42623D; margin-bottom:0px;">เกี่ยวกับเรา</h1>
    ...
    <section style="padding:0;">
        <div class="text-center mt-5">
            <span class="whyeatfont" data-animate="fadeInUp">ทำไมต้องเลือกทานอาหารคลีนกับ <span class="whyeatfont2">PASSIONFOOD</span></span>
        </div>
        <img class="mt-5" src="{{ asset('images/passionfood/img/img35.png') }}" data-animate="fadeInLeft" onContextMenu="return false;"
            width="100%">
    </section>

    {{-- avocado --}}
    <img class="bgimg2" src="{{ asset('images/passionfood/img/img18.png') }}" onContextMenu="return false;" width="100%">
            ...
            <form class="">
                ...
                <a class="button-73 mt-4" href="#"
                    style="display:block; margin:auto; border-radius:100px; width:20%;"><span
                        style="font-size:1.6rem;">กดคำนวณ&nbsp;&nbsp;<i class="fa fa-arrow-right" style="font-size:1.6rem;"
                            aria-hidden="true"></i></span></a>
            </form>
        </div>
    </section>
    <section class="d-block d-lg-none"
        style="padding-top: 0px !important; padding-bottom: 80px; z-index:15; background-color:transparent !important;" data-animate="fadeInUp">
        <div class="container">
            <h2 class="bmr">BMR CALCULATOR</h2>
            <p class="bmrbody">เครื่องคำนวณหาค่า BMR เเละ TDEE
                เครื่องคำนวณช่วยวางแผนการลดน้ำหนัก เพื่อให้เพื่อนๆได้คำนวณค่าพลังงานที่เหมาะสมและเพื่อการวางแผน
