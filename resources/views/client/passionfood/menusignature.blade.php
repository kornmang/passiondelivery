...
@section('content')
    ...
    <section>
        <div class="container">
            <h1 class="signatureheader" data-animate="fadeInUp" style="">Passion Food Signature</h1>
            {{-- Pc --}}
            <div class="autoplay d-none d-sm-block" data-animate="fadeInUp">
                    ...
                    <div class="post-item border">
                        <div class="post-item-wrap"
                            ...
                            <div class="post-item-description text-center">
                                <h4 class="text-center headermenu">ซูชิโรลไข่ขาวน้ำพริกกะปิปลาทูชะอม</h4>
                                <h4 class="text-center pricemenu">ราคา 189.-</h4>
                ...
                <div class="portfolio-item" style="padding:5px;">
                    <div class="post-item border">
                        <div class="post-item-wrap"
                            ...
                            <div class="post-item-description text-center">
                                <h4 class="text-centerheadermenu">ซูชิโรลไข่ขาวน้ำพริกกะปิปลาทูชะอม</h4>
                                <h4 class="text-center pricemenu">ราคา 189.-</h4>
                                <div class="col text-center mt-2">
                                    {{-- <a class="button-73 " id="btnSend" onclick="sendEmail('pc')" style="border-radius:100px; width:40%;  text-align:center !important; color:#fff !important; background-color:#89C54D; ">Submit</a> --}}
                                    <a class="button-73"
            ...
            {{-- Mobile --}}
            <div class="autoplaymobile d-block d-sm-none">
                <div class="portfolio-item" style="padding:5px;">
                    <div class="post-item border">
                        <div class="post-item-wrap"
